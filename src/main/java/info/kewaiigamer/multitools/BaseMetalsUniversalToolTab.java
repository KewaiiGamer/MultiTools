...
public class BaseMetalsUniversalToolTab extends CreativeTabs {
    static Comparator<ItemStack> tabSorter;

    public BaseMetalsUniversalToolTab() {
        super("basemetals_universaltools");
    }

    @Override
    public ItemStack getTabIconItem() {
        return ModItems.baseMetalsUniversalTools.get(0).getDefaultInstance();
    }
    ...
    public void displayAllRelevantItems(NonNullList<ItemStack> itemStackNonNullList) {
        ...
        tabSorter = Ordering.explicit(ModItems.baseMetalsUniversalTools).onResultOf(ItemStack::getItem);
