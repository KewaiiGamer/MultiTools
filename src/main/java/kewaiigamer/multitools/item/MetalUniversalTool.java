...
public class MetalUniversalTool extends ItemPickaxe {
	public MetalUniversalTool(EnumMaterialEquipment equipment) 
	{
		super(equipment.tool);
		setUnlocalizedName(Reference.MODID + ".universaltool" + equipment.material.suffix);
		setRegistryName("universaltool" + equipment.material.suffix);
	}
